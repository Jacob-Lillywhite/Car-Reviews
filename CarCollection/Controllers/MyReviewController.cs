...
namespace CarCollection.Controllers
{
    ...
    public class MyReviewController : Controller
    {
        ...
        public MyReviewController(IUnitOfWork unitOfWork, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public IActionResult Get()
        {
            ...
            return Json(new { data = _unitOfWork.Review.GetAll(null, null, "Car,ApplicationUser").Where(d=> d.ApplicationUserId == UserId ) });
        }
        [HttpDelete("{id}")]
